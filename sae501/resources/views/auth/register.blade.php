    ...
    <main class="flex-1 flex items-center justify-center pb-8 z-10 w-full">
        <div class="w-full max-w-8xl flex flex-row md:flex-row bg-transparent shadow-none">
            ...
            <div class="flex-1 flex items-center justify-center">
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-4 max-w-md w-full mx-auto bg-white/85 p-8 rounded-2xl shadow-2xl z-20 backdrop-blur border-[2px] border-[#0CBABA99]">
                    @csrf
                    <h3 class="text-2xl font-bold mb-4 text-center" style="color:#380036;">Créer un compte</h3>
                    <!-- Name -->
                    <div>
                        <label for="name" class="block text-sm font-medium" style="color:#380036">Nom<span class="text-red-500">*</span></label>
                    ...
                    <!-- Email -->
                    <div>
                        <label for="email" class="block text-sm font-medium" style="color:#380036">Adresse email<span class="text-red-500">*</span></label>
                    ...
                    <div class="flex justify-between items-center mt-4">
                        <a href="{{ route('login') }}" class="text-sm" style="color:#0CBABA">Déjà inscrit ?</a>

                        <button type="submit"
                                class="bg-[#0CBABA] hover:bg-[#380036] text-white font-semibold px-4 py-2 rounded shadow">
                            Inscription
                        </button>
                    </div>
                </form>
