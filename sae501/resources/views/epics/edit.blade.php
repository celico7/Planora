...
<div class="max-w-xl mx-auto bg-white rounded p-6 shadow">
    <h2 class="text-2xl font-bold mb-4">Modifier l'Epic</h2>

    <form method="POST" action="{{ route('epics.update', [$project, $epic]) }}">
        @csrf
        @method('PUT')
        ...
        <div class="flex gap-4 justify-end mt-8">
            <a href="{{ route('projects.show', $project) }}" class="btn border px-4 py-2 rounded bg-gray-100">Annuler</a>
