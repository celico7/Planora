...
<body class="bg-gray-100 min-h-screen flex flex-col">
        ...
        <div class="container mx-auto px-4 py-4 flex justify-between items-center">
            ...
            <nav>
                <ul class="flex space-x-6">
                    <li><a href="#" class="text-gray-700 hover:text-green-600">Accueil</a></li>
                    ...
                    <li class="relative group">
                        ...
                        <ul class="absolute right-0 mt-2 w-40 bg-white border rounded shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-10">
                            <li>
                                <a href="/inscription" class="block px-4 py-2 text-gray-700 hover:bg-gray-100">S'inscrire</a>
                            </li>
                            <li>
                                <a href="/connexion" class="block px-4 py-2 text-gray-700 hover:bg-gray-100">Se connecter</a>
                            </li>
                        </ul>
                    </li>
                        </ul>
    ...
    <main class="flex-1 container mx-auto px-4 py-8">
        <h2 class="text-xl font-semibold text-gray-800 mb-4">Se connecter</h2>
